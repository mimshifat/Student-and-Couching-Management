...
class FeeRecordModel extends FeeRecord {
  ...
  factory FeeRecordModel.fromMap(Map<String, dynamic> map) {
    return FeeRecordModel(
      ...
      note: map['note'],
      paymentDate: map['payment_date'] != null ? DateUtilsHelper.parseFromDb(map['payment_date']) : null,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'batch_id': batchId,
      'batch_details_snapshot': batchDetailsSnapshot,
      'note': note,
      'payment_date': paymentDate != null ? DateUtilsHelper.formatForDb(paymentDate!) : null,
